...
haarcasecade_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "haarcascade_frontalface_default.xml")
trainimagelabel_path = (
    "./TrainingImageLabel/Trainner.yml"
)
# Ensure BASE_DIR is available for early path setup
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
# Use project-local directories instead of absolute paths at root
